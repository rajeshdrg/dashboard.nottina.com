...
class EsmsCDAlerta {
    ...
    public $terminais;
    public $qtd_alertas;
    public $qtd_terminais;
    public $qtd_blacklist;
	...
	fclose($arq);
        ...
        $this->qtd_terminais =  $this->xml->terminais;
	$this->qtd_blacklist =  $this->xml->blacklist;
	...
	print "<b>Cadastro</b><br>";
        print  "<span>".number_format((float) $this->qtd_terminais,0,',','.')." terminais</span><br>"; 
        print  "<span>".number_format((float) $this->qtd_blacklist,0,',','.')." blacklist</span><br>"; 
	print "<b>Alertas</b><br>";
        print  "<span '>$this->qtd_alertas alertas, ".number_format($this->terminais,0,',','.')." terminais enviados</span>"; 
	...
	print "<div class='card-content'>";
          foreach($this->xml->alerta as $al) {
            ...
            print "<p>".(string) $al->cod_alerta."</p>";
