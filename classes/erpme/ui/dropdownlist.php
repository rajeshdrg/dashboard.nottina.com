...
class DropDownList {
	...
	public function DropDownList($nome) {
		$this->name = $nome;
		$this->size="10";
	...
	public function ShowMe()
    {
		...
		if($this->ShowLabel) print "<label for='$this->name' $lclass >$this->label</label>";
        ...
        if($this->multiple==true) 
	    	print "<select $this->disabled name=$this->name"."[] id=$this->name style='background:$this->SelectColor;width:$this->width;' multiple ";
	    else
