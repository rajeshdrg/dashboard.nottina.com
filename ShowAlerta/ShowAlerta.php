...
EOT;
        ...
        while ($o = $this->data->GetObject()) {
            print "<tr>";
            print "<td><span onclick=\"alerta('$o->id_alerta')\">...</span></td>";
            ...
            print "<td>$o->nome</td>";
            print "<td onclick=\"openEditForm('$o->id_alerta')\"><img class=\"edit\" src='/images/icon_edit.png' alt='edit' data-id='$o->cod_alerta'></td>";
            print "</tr>";
        }
    }
}
